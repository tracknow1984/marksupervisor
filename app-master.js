...
app.use((req,res,next)=>{
  ...
  res.send=(body)=>{
    ...
    if(typeof body==='string'&&req.path==='/gps'){
      ...
      body=body.replace('</body>',gpsActionIcons+'</body>');
    }
